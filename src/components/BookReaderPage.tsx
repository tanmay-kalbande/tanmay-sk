            ...
            <div className="reader-stats">
              ...
              {book.modelUsed && (() => {
                ...
                if (m.includes('gemma')) {
                  ...
                  iconComponent = (
                    <svg width="13" height="13" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, color: '#3b82f6' }}>
