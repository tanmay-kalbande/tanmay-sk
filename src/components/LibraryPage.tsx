                      ...
                      >
                        ...
                        <div className="lib-card-meta">
                          ...
                          {book.modelUsed && (() => {
                            ...
                            let iconSrc = '';
                            if (m.includes('gemma')) iconSrc = '/assets/gemma-color.svg';
                            else if (m.includes('gpt-oss') || m.includes('openai')) iconSrc = '/assets/openai.svg';
                            else if (m.includes('mistral')) iconSrc = '/assets/mistral-color.svg';
                            else if (m.includes('zai') || m.includes('glm')) iconSrc = '/assets/zai.svg';
                            if (!iconSrc) return null;
                            return (
                              <span title={`Generated by ${book.modelUsed}`} style={{ display: 'inline-flex', alignItems: 'center' }}>
                                <img src={iconSrc} alt={book.modelUsed} width={12} height={12} style={{ objectFit: 'contain' }} />
                              </span>
                            );
                          })()}
                        </div>
