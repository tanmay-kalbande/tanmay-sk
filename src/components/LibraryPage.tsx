                      ...
                      {visibleBooks.map((book) => (
                        ...
                        >
                          <div className="lib-card-header">
                            <div className={`lib-card-badge lib-card-badge--${(book.complexity || 'beginner').toLowerCase()}`}>
                              <span className="lib-card-dot" />
                              <span>{(book.complexity || 'beginner').toUpperCase()}</span>
                            </div>
                          </div>
                          ...
                          <div className="lib-card-stats">
                            <span>{book.moduleCount || 8} modules</span>
                            <span className="lib-card-sep">·</span>
                            <span>{book.wordCount ? Number(book.wordCount).toLocaleString() : '3,500'} words</span>
                            <span className="lib-card-sep">·</span>
                            <span>{book.readingTimeMins || 25} min</span>
                          </div>
