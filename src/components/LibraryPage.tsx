                      ...
                      >
                        ...
                        <div className="lib-card-meta">
                          ...
                          {book.modelUsed && (() => {
                            ...
                            if (m.includes('gemma')) {
                              iconComponent = (
                                <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, color: '#2e96ff' }}>
                              ...
                              iconComponent = (
                                <svg width="11" height="11" viewBox="0 0 24 24" fill="currentColor" style={{ flexShrink: 0, color: '#10a37f' }}>
